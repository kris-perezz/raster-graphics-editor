...
namespace RGE {
Renderer::Renderer(SDL_Window *window, std::shared_ptr<RGE::ComputeShader> computeShader,
  ...
  glTexImage2D(GL_TEXTURE_2D, 0, GL_RGBA32F, state.canvasWidth, state.canvasHeight, 0, GL_RGBA,
               GL_FLOAT, nullptr);
